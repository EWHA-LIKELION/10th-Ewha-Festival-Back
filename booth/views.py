...
class BoothDetailView(views.APIView):
    ...
    def patch(self, request, pk):
        ...
        serializer = self.serializer_class(
            data=request.data, instance=booth, partial=True)
...
class MenuDetailView(views.APIView):
    ...
    def patch(self, request, pk):
        ...
        serializer = self.serializer_class(
            data=request.data, instance=menu, partial=True)
...
class SearchView(views.APIView):
    ...
    def get(self, request):
        ...
        booths = Booth.objects.filter(name__contains=keyword) | Booth.objects.filter(
            menus__menu__contains=keyword)
